...
namespace Xamvvm.Maui.Factory
{
	public partial class XamvvmMauiFactory : IBaseFactory
	{
		...
		public XamvvmMauiFactory(Application appInstance, int maxPageCacheItems = 6, bool automaticAssembliesDiscovery = true, params Assembly[] additionalPagesAssemblies)
		{
			...
			if (createMasDet == null)
			{
				...
				createMasDet = new Func<IBasePage<IBasePageModel>, IBasePage<IBasePageModel>, IBasePage<TPageModel>>(
					(master, detail) =>
					{
						...
						var masdetPageXam = (FlyoutPage)masdetPage;
						masdetPageXam.Flyout = master as Page;
